...
private static final long serialVersionUID = 50185165626007484L;
	...
	//token is valid upto 5 hours
	public static final long JWT_TOKEN_VALIDITY = 5*60*60;

	//passcode to validate jwt token
	@Value("${jwt.secret}")
	...
	//checking token expiry in this method
	...
	//the actual method which will generate jwt token using HS512 signature algorithm and returns jwt token as string
